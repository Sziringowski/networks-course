...
##### запросили майн
![get_main](../lab03/demo/1.1.png)

##### посмотрели, что выдал сервер
![get_main_message](../lab03/demo/1.2.png)

##### запросили `file_1`
![get_file_1](../lab03/demo/1.3.png)

#### запросили `file_2`, а его нет
![get_file_2](../lab03/demo/1.4.png)
...
##### послали гет на `file_1`
![get_client](../lab03/demo/2.1.png)

##### не получилось найти `file_2`
![get_client_error](../lab03/demo/2.2.png)
